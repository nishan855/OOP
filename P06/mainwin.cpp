...
//     order
    // Create a order menu and place to the menu bar
...
Gtk::Menu *ordersmenu = Gtk::manage(new Gtk::Menu());
    ...
    //         place  order
    // Append place to the order menu
    menuitem_place_order = Gtk::manage(new Gtk::MenuItem("Place", true));
    //menuitem_place_order->signal_activate().connect([this] {this->on_add_order_click();});
    ordersmenu->append(*menuitem_place_order);

    //         L I S T   order
    // Append List to the order menu
     menuitem_list_orders= Gtk::manage(new Gtk::MenuItem("List", true));
    //menuitem_list_order->signal_activate().connect([this] {this->on_list_order_click();});
